...
export const gameTable = pgTable('games', {
  ...
  // Players of Team 1
  team1Player1: integer('team1_player1').notNull().references(() => playerTable.id),
  team1Player2: integer('team1_player2').notNull().references(() => playerTable.id),
  
  // Players of Team 2
  team2Player1: integer('team2_player1').notNull().references(() => playerTable.id),
  team2Player2: integer('team2_player2').notNull().references(() => playerTable.id),
